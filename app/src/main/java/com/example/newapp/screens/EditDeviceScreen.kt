...
fun EditDeviceScreen(
    ...
    val device = deviceDatabaseHelper.getDeviceById(deviceId)
    ...
    val roomList = roomDatabaseHelper.getAllRooms().map { it.name }
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                actions = {
                    IconButton(onClick = {
                        deviceDatabaseHelper.deleteDeviceById(deviceId)
        ...
        content = { paddingValues ->
            Column(
                ...
                Button(
                    onClick = {
                        if (deviceName.isNotBlank() && deviceType.isNotBlank() && selectedRoom.isNotBlank()) {
                            deviceDatabaseHelper.updateDeviceById(
                                deviceId,
                                deviceName,
                                deviceType,
                                selectedRoom
